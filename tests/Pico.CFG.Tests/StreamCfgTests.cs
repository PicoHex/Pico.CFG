...
public class StreamCfgTests
{
    ...
    {
        var streamFactory = () => new MemoryStream(Encoding.UTF8.GetBytes("\nkey1=value1\n\nkey2=value2\n"));
        var provider = new StreamCFGProvider(streamFactory);
    ...
    {
        var streamFactory1 = () => new MemoryStream(Encoding.UTF8.GetBytes("key1=oldvalue\nkey2=value2"));
        ...
        var streamFactory2 = () => new MemoryStream(Encoding.UTF8.GetBytes("key1=newvalue\nkey3=value3"));
